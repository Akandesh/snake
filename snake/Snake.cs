...
namespace snake
{
    ...
    class Snake
    {
        ...
        public void Reset( ) {
            ...
            _lastValidDirectionEvent = DirectionEvent.UP;
            ...
            for ( int i = 0; i < 3; i++ ) {
                Point curPoint = new Point( ) { X = _gameWidth / 2, Y = _gameHeight / 2 + i };
        ...
        void DrawGameOver( ) {
            ...
            if ( !hitEnter || inputName.Trim( ).Trim( '\0' ).Length == 0 )
                return;
        ...
        public void OnDirectionEvent( DirectionEvent e ) {
            ...
            CurrentInterval = verticalMovement ? 1000 / speed : 1000 / (int)( speed * 2 );
            //CurrentInterval = 0;
        }
